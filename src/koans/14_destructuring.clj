...
(meditations
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[first-name last-name] {street-address :street-address, city :city, state :state}] (str first-name " " last-name ", " street-address ", " city ", " state)) ["Test" "Testerson"] test-address)))
